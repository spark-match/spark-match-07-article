...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[
        ...
        \node[block, right=of api] (agent) {Deep Agent\\(LangGraph)};
...
\subsection{Agente conversacional (Deep Agent / LangGraph)}

El agente se implementa como un \emph{Deep Agent} sobre LangGraph que delega en
subagentes especializados (evaluaci\'on del perfil y \emph{matching} de
carreras). El perfil del estudiante se persiste con \texttt{langmem}, de modo que
