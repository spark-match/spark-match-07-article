...
memoria). La Figura~\ref{fig:ev-filtros} muestra la vista de \emph{filtros}
desplegada, que precarga el contexto del chat (tipo de gesti\'on, universidad o
instituto y presupuesto m\'aximo) antes de iniciar la orientaci\'on.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{fig-evidencia-filtros.png}
    \caption{Vista de \emph{filtros} del frontend desplegado: gesti\'on
    (p\'ublica/privada), tipo de instituci\'on y presupuesto anual, que precargan
    el contexto de la conversaci\'on.}
    \label{fig:ev-filtros}
\end{figure}
